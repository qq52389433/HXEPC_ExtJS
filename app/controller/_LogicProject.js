Ext.define('CDMSWeb.controller._LogicProject', {
    ...
    views: [
        '_LogicProject.View', 'Ext.ux.YDForm._contextMenu'
    ],
    ...
    refs: [
         ...
         { ref: "_LogicProjectPanel", selector: "#_logicProjectPanel" }
    ...
    init: function () {
        var me = this,
            panel = me.get_LogicProjectPanel();  //获取ContentPanel实例

        me.view = Ext.widget("_logicprojectview");//视图路径：\Scripts\app\view\Content\View.js
        panel.add(me.view);
