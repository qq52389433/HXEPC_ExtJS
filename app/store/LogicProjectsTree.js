//定义逻辑目录分類树Store
Ext.define("CDMSWeb.store.LogicProjectsTree", {
    extend: 'Ext.data.TreeStore',
    batchActions: false,
    remoteFilter: false,
    remoteSort: false,
    model: "CDMSWeb.model.LogicProjectTree",
    ...
    proxy: {
        ...
        //api: {
        //    read: 'Project/GetProjectListJson?ProjectType=4' + '&sid=' + localStorage.getItem("sid"),//调用路径：\simplecdms\controllers\projectcontroller.cs
        //    create: 'Project/Add',
        ...
        extraParams: {
            ...
            ProjectType: 4, sid: localStorage.getItem("sid")
        },
