Ext.define('Ext.plug_ins.HXPC_Plugins.selectUserApprov', {
    ...
    initComponent: function () {
        ...
        me.selectusergrid = Ext.widget("grid", {
            ...
            columns: [
                ...
                { text: '校核人', dataIndex: 'checker', width: 110 },
                { text: '审核人', dataIndex: 'auditor', width: 110 },
                { text: '批准人', dataIndex: 'approver', width: 110 }
            ],
            listeners: {
