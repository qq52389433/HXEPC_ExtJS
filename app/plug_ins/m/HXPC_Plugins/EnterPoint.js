Ext.define('Ext.plug_ins.m.HXPC_Plugins.EnterPoint', {
    ...
    MenuSelectProfession: function (mainPanelId){
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            var fmSelectProfession = Ext.create('Ext.plug_ins.m.' + plugins + '.' + state,
    ...
    MenuExchangeDoc: function (mainPanelId) {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            var fmExchangeDoc = Ext.create('Ext.plug_ins.m.' + plugins + '.' + state,
            ...
            fmExchangeDoc.sendGetExchangeDocDefault(function () {
                winExchangeDoc.show();
            });
    ...
    MenuCompany: function (mainPanelId) {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            var fmEditCompany = Ext.create('Ext.plug_ins.m.' + plugins + '.' + state,
    ...
    MenuSendDocument: function (mainPanelId) {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            var fmSendDocument = Ext.create('Ext.plug_ins.m.' + plugins + '.' + state,
                { title: "", mainPanelId: mainPanelId, projectKeyword: projectKeyword });
    ...
    MenuCreateProdect: function (mainPanelId) {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            var fmCreateProdect = Ext.create('Ext.plug_ins.m.' + plugins + '.' + state,
                { title: "", mainPanelId: mainPanelId, projectKeyword: projectKeyword });
    ...
    MenuWorkTask: function (mainPanelId) {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            var fmCreateTask = Ext.create('Ext.plug_ins.m.' + plugins + '.' + state,
                { title: "", mainPanelId: mainPanelId, projectKeyword: projectKeyword });
