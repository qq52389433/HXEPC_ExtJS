/*批量创建文档*/
Ext.define('Ext.plug_ins.SysPlugins._BatchCreateDoc', {
    extend: 'Ext.container.Container',
    alias: 'widget._BatchCreateDoc',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
                            ...
                            if (nodes !== null && nodes.length > 0) {
                                ...
                                for (var i = 0; i < arr.length ; i++) {
                                    ...
                                    if (arrItem[0] != "") {
                                        ...
                                        rec.set('docCode', arrItem[0]);
                                        rec.set('docDesc', arrItem[1]);
                                        rec.commit();
                                    }
                                }
        ...
        Ext.define("contentModel", {
            ...
            fields: ["id", "docCode", "docDesc", "tempDef"],
            url: "_blank",
        });
        ...
        me.contentGrid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {
                    header: '代 码', dataIndex: 'docCode', width: 381,
                    editor:  me.CodeEditing
                },
                {
                    header: '描 述', dataIndex: 'docDesc', width: 381,
    ...
    //循环创建文档
    loop_create_doc: function (docIndex) {
        var me = this;
        var records = me.contentStore.getRange();
        if (docIndex >= records.length) {
            winBatchCreateDoc.close();
        } else {
            if (records[docIndex].data.docCode === "") {
                docIndex = docIndex + 1;
                //循环创建文档
                me.loop_create_doc(docIndex);
            } else {
                docAttr =
                [{ name: 'docCode', value: records[docIndex].data.docCode },
                    { name: 'docDesc', value: records[docIndex].data.docDesc },
                ...
                Ext.Ajax.request({
                    ...
                    params: {
                        ...
                        sid: localStorage.getItem("sid"), projectKeyword: me.projectKeyword, docAttrJson: docAttrJson,
                    },
    ...
    batch_send_create_Doc: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.WebApi.DocController", A: "BatchCreateDoc",
