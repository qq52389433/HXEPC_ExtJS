...
Ext.define('Ext.plug_ins.HXEPC_Plugins.Document.DraftReport', {
    ...
    initComponent: function () {
        ...
        //定义文件著录属性panel
        me.fileAttrGridPanel = Ext.create('Ext.plug_ins.HXEPC_Plugins.Document.FileAttrGridPanel', { projectKeywor: me.projectKeyword });
        ...
        //定义责任单位Text
        me.accountUnitText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "责任单位", anchor: "80%", labelWidth: 70, labelAlign: "left", width: "50%",//width: 230, 
        ...
        me.sendDateField = Ext.create("Ext.form.field.Date", {
            ...
            name: "date",
            fieldLabel: '编制日期', fieldStyle: ' background-image: none;',
    ...
    send_draft_report: function () {
        ...
        //获取函件编号Text
        var reportCode = me.reportCodeText.value;
        ...
        [
            ...
            { name: 'accountUnit', value: accountUnit },//联系人
            { name: 'tel', value: tel }
        ];
        ...
        Ext.Ajax.request({
            ...
            success: function (response, options) {
                me.draft_report_callback(response, options, "");//, me.projectKeyword, closeWin);
            },
